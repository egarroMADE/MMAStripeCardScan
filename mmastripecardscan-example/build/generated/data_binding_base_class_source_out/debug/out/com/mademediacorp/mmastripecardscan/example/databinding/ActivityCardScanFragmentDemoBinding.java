...
public final class ActivityCardScanFragmentDemoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCardScanFragmentDemoBinding(@NonNull CoordinatorLayout rootView,
      @NonNull CoordinatorLayout coordinator, @NonNull FragmentContainerView fragmentContainer,
      @NonNull Button launchScanButton, @NonNull ScrollView scanResultScroll,
      @NonNull TextView scanResultText) {
  ...
  @NonNull
  public static ActivityCardScanFragmentDemoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCardScanFragmentDemoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_card_scan_fragment_demo, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCardScanFragmentDemoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCardScanFragmentDemoBinding((CoordinatorLayout) rootView, coordinator,
          fragmentContainer, launchScanButton, scanResultScroll, scanResultText);
    }
