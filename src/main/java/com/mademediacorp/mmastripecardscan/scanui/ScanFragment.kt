package com.mademediacorp.mmastripecardscan.scanui
...
import com.mademediacorp.mmastripecardscan.camera.DefaultCameraErrorListener
import com.stripe.android.core.storage.StorageFactory
import com.mademediacorp.mmastripecardscan.mlcore.impl.InterpreterInitializerImpl
...
private const val PERMISSION_STORAGE_NAME = "CardScanPermissionStorage"
...
//    }
    ...
    val storage: SharedPreferences by lazy {
        requireContext().getSharedPreferences(PERMISSION_STORAGE_NAME, Context.MODE_PRIVATE)
    }
